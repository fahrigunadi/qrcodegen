    ...
    <div class="md:flex md:justify-between gap-4 pt-5">
      <form v-on:submit.prevent="onSubmit" class="flex-1">
        <div>
          ...
          <input ref="inputEl" type="url" v-model="link" id="link"
        ...
        <div class="mt-3">
          ...
          <input type="text" v-model="tab" id="tab"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
            placeholder="Some tab" required />
        </div>
        ...
        <button type="button" v-on:click="reset"
          class="text-gray-900 mt-3 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">Reset</button>
      </form>
