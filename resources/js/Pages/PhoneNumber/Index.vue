  ...
  <Main>
    <div class="md:flex md:justify-between gap-4 pt-5">
      <form v-on:submit.prevent="onSubmit" class="flex-1">
        <InputLabel for="content">Phone Number</InputLabel>
        <Input type="tel" v-model="content" id="content" placeholder="08123456789" required autofocus />
...
const onSubmit = async () => {
  await generateQr("tel:" + content.value, variant.value)
}
</script>
