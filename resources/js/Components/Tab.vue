<template>
  <div class="border-b border-gray-200 dark:border-gray-700 mt-20">
    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
      ...
      <li class="me-2">
        <a href="#" v-bind:class="itemClass(page.url.startsWith('/phone-number'))">
      ...
      <li class="me-2">
        <a href="#" v-bind:class="itemClass(page.url.startsWith('/v-card'))">
      ...
      <li class="me-2">
        <a href="#" v-bind:class="itemClass(page.url.startsWith('/email'))">
...
import { Bars3BottomLeftIcon, EnvelopeIcon, IdentificationIcon, LinkIcon, PhoneIcon } from "@heroicons/vue/24/outline"
...
const itemClass = (active: boolean) => {
  ...
  return "inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group"
}
</script>